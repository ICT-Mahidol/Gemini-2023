...
# Identifying Actor
A.Astronomer. This person is using the Gemini system for the collection of science data. In
...
is responsible for ensuring the integrity of the system and for keeping the system functioning accurately during observations. The Telescope Operator works with the Observer and
...
the system, hardware and software, as well as the installation of subsystems and configuration changes.
