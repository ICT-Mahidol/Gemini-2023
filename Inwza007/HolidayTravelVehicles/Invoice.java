...
public class Invoice {
    ...
    public Invoice(String invoiceNo, Date invoiceDate, Customer customer, Vehicle vehicle,
            TradeInVehicle tradeinvehicle, double price, DealerInstallOption dealerinstalloption) {
    ...
    public Invoice(String invoiceNo, Date invoiceDate, Customer customer, Vehicle vehicle,
            TradeInVehicle tradeinvehicle, double price) {
        this.invoiceNo = invoiceNo;
        this.invoiceDate = invoiceDate;
        this.customer = customer;
        this.vehicle = vehicle;
