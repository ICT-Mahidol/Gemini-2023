...
public class _ObservingProgram {
    ...
    public void createObservingProgram(OCS ocs){
        edu.gemini.app.ocs.model.ObservingProgram op = ocs.createObservingProgram(ocs.getSciencePlanByNo(planNo), "GNZ",
                1.9, 7, 33, scienceFoldMirrorType,
                2, calibrationUnit, lightType, telePositionPair);
    }
}
